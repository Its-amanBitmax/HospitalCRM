                        ...
                        <div class="relative">
                            ...
                            @if($employee->image)
                                <img src="{{ Storage::url($employee->image) }}"
                                    alt="{{ $employee->name }}"
                                    class="relative w-20 h-20 rounded-full object-cover border-1 border-white shadow-lg">
                            @else
                                <div class="relative w-20 h-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold text-2xl border-4 border-white shadow-lg">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2 mt-2">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    ...
                                    {{ $employee->professions->first()->title ?? 'Registered Nurse' }}
                                </span>
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-lg border border-blue-200 overflow-hidden">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-xl font-bold text-gray-900">Today's Tasks Overview</h3>
                        <p class="text-gray-600 mt-1">Your assigned duties and responsibilities</p>
                    </div>
                    <a href="{{ route('nurse.tasks') }}" class="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-lg font-medium hover:bg-indigo-200 transition-colors duration-200 flex items-center gap-2 text-sm">
                        View All Tasks
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-gray-900">{{ $todayTasks->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-gray-900">{{ $inProgressTasks->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-gray-900">{{ $pendingTasks->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-gray-900">{{ $completedTasks->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-gray-900">{{ $upcomingTasks->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const markAttendance = async (type) => {
            ...
            try {
                ...
                const response = await fetch("{{ route('nurse.mark.attendance') }}", {
                    method: "POST",
                    headers: {
