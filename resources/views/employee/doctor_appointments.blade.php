    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white bg-white-800 rounded-2xl shadow-sm border border-gray-200 border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 text-gray-400">Confirmed</p>
        ...
        <div class="bg-white bg-white-800 rounded-2xl shadow-sm border border-gray-200 border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 text-gray-400">Pending</p>
        ...
        <div class="bg-white bg-white-800 rounded-2xl shadow-sm border border-gray-200 border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 text-gray-400">Total Appointments</p>
    ...
    <div class="bg-white bg-white-800 rounded-2xl shadow-sm border border-gray-200 border-gray-700 overflow-hidden mb-10">
        ...
        <div class="overflow-x-auto">
            ...
            <div class="p-16 text-center">
                ...
                <p class="text-gray-500 text-gray-400">No upcoming appointments</p>
            </div>
            @else
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 divide-gray-700">
                    ...
                    <tr class="hover:bg-white-50 hover:bg-white-700/50 transition">
                        ...
                        <td class="px-6 py-4 text-sm">
                            {{ Carbon::parse($app->appointment_time)->format('h:i A') }}
                        </td>
                        ...
                        <td class="px-6 py-4 text-sm">{{ $app->issue ? Str::limit($app->issue, 30) : '—' }}</td>
    ...
    <div class="bg-white bg-white-800 rounded-2xl shadow-sm border border-gray-200 border-gray-700 overflow-hidden mt-10">
        ...
        <div class="overflow-x-auto">
            ...
            <div class="p-16 text-center">
                ...
                <p class="text-gray-500 text-gray-400">No appointment records found</p>
            </div>
            @else
...
<div id="appointmentModal" class="fixed inset-0 bg-white/50 hidden items-center justify-center z-50">
    <div class="bg-white bg-white-800 rounded-2xl shadow-xl w-full max-w-lg mx-4 relative">
        ...
        <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200 border-gray-700">
            <h2 class="text-lg font-semibold text-gray-800 text-white">Appointment Details</h2>
            <button onclick="closeModal()" class="text-gray-400 hover:text-gray-600 hover:text-gray-200 text-xl">&times;</button>
        </div>
        ...
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 border-gray-700">
            <button onclick="closeModal()" class="bg-white-600 hover:bg-white-700 text-white font-medium px-4 py-2 rounded-lg">Close</button>
