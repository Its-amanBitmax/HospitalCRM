...
<div class="min-h-screen">
    ...
    <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
        ...
        <div class="flex gap-3">
            <a href="{{ route('employee.doctor_patients') }}" class="bg-white-200 hover:bg-white-300 text-gray-900 px-4 py-2 rounded-lg transition duration-200 shadow-md hover:shadow-lg">
    ...
    <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200">
                    ...
                    <tbody class="bg-white bg-white-800 divide-y divide-gray-200 divide-gray-700">
                        ...
                        <tr class="hover:bg-white-50 hover:bg-white-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                                <a href="{{ route('employee.users.checkups.edit', [$user->id, $checkup->id]) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
                                <form action="{{ route('employee.users.checkups.delete', [$user->id, $checkup->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this checkup?');">
                                    @csrf
                                    @method('DELETE')
        ...
        <div id="documents-content" class="tab-content hidden">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('employee.users.documents.create', $user->id) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2">
                    ...
                    <tbody class="bg-white bg-white-800 divide-y divide-gray-200 divide-gray-700">
                        ...
                        <tr class="hover:bg-white-50 hover:bg-white-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                                ...
                                <form action="{{ route('employee.users.documents.delete', [$user->id, $document->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this document?');">
                                    @csrf
                                    @method('DELETE')
...
<script>
    ...
    function showTab(tabName) {
        const allTabs = ['checkups', 'documents', 'summary'];
