...
<div class="min-h-screen p-6">
    ...
    <div class="flex justify-between items-center bg-white p-4 rounded-lg shadow mb-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-semibold">Edit Checkup - {{ $user->full_name }}</h1>
        </div>
        <a href="{{route('employee.users.summary', $user->id)}}"
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        <form action="{{ route('employee.users.checkups.update', [$user->id, $checkup->id]) }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="visit_id" class="block w-full border px-3 py-2 rounded focus:ring focus:ring-blue-300">
                        ...
                        <option value="{{ $visit->id }}"
                            {{ $checkup->visit_id == $visit->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="date" name="checkup_date" required
                        value="{{ \Carbon\Carbon::parse($checkup->checkup_date)->format('Y-m-d') }}"
                        class="block w-full border px-3 py-2 rounded focus:ring focus:ring-blue-300">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="diagnosis" rows="3"
                        class="block w-full border px-3 py-2 rounded focus:ring focus:ring-blue-300"
                        placeholder="Enter diagnosis">{{ $checkup->diagnosis }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="treatment" rows="3"
                        class="block w-full border px-3 py-2 rounded focus:ring focus:ring-blue-300"
                        placeholder="Enter treatment">{{ $checkup->treatment }}</textarea>
                </div>
            ...
            <div class="flex justify-end mt-4">
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-1"></i>Update Checkup
                </button>
            </div>
