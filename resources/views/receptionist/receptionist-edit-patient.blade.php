...
<style>
    @media print {
        ...
        .flex.justify-between.items-center.bg-white.\\:bg-white-800.p-4.rounded-lg.shadow.mb-6 {
        ...
        .bg-white.\\:bg-white-800.rounded-lg.shadow-lg.p-6 {
            box-shadow: none;
            border: none;
        }
    }
...
<div class="min-h-screen">
    ...
    <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
        ...
        <div class="flex gap-3">
            <a href="{{route('receptionist.patients')}}" class="bg-white-600 hover:bg-white-700 text-black px-4 py-2 rounded-lg transition duration-200 shadow-md hover:shadow-lg">
    ...
    <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200 ">
        <form id="editUserForm" action="{{ route('patients.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="space-y-6">
                    ...
                    fetch(this.action, {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    window.location.href = '{{ route("receptionist.patients") }}';
                                }, 2000);
                            } else {
