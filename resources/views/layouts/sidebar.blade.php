<aside id="sidebar" class="w-64 fixed top-0 left-0 h-screen overflow-y-auto shadow-xl transition-all duration-300 bg-cyan-400" style="-ms-overflow-style: none; scrollbar-width: none; z-index: 1006;">
  ...
  <nav class="p-4 space-y-4">
    ...
    <!-- Manage Section -->
    <div>
      <p class="text-xs text-cyan-600 dark:text-cyan-400 font-semibold uppercase mt-6 mb-3 tracking-wider bg-cyan-50 dark:bg-cyan-900/20 px-3 py-2 rounded-lg border border-cyan-100 dark:border-cyan-800 sidebar-text">Management</p>
      
      <div id="employee-toggle" class="flex items-center justify-between mt-2 mb-1 cursor-pointer px-3 py-3 rounded-lg transition-all duration-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 border border-transparent hover:border-cyan-200 group">
        <div class="flex items-center space-x-3">
          <i class="fas fa-users-cog text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-5 text-center"></i>
          <span class="text-sm text-cyan-700 dark:text-cyan-300 font-semibold sidebar-text group-hover:text-cyan-800 dark:group-hover:text-cyan-200">Employee</span>
        </div>
        <i class="fas fa-chevron-down transition-transform duration-200 text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 text-sm" id="employee-icon"></i>
      </div>
      
      <div id="employee-dropdown" class="space-y-2 overflow-hidden transition-all duration-300 max-h-0 ml-4 border-l-2 border-cyan-200 dark:border-cyan-700 pl-3 mt-1">
        <a href="{{ route('admin.departments') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.departments') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-building text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Department</span>
        </a>
        <a href="{{ route('admin.employees.index') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.employees.*') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-user text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Employee Details</span>
        </a>
        <a href="{{ route('admin.specialities.index') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.specialities.*') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-money-bill-wave text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Salary</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-id-card text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Identity Card</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-clock text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">OT Handling</span>
        </a>
      </div>
      
      <div id="services-toggle" class="flex items-center justify-between mt-3 mb-1 cursor-pointer px-3 py-3 rounded-lg transition-all duration-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 border border-transparent hover:border-cyan-200 group">
        <div class="flex items-center space-x-3">
          <i class="fas fa-headset text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-5 text-center"></i>
          <span class="text-sm text-cyan-700 dark:text-cyan-300 font-semibold sidebar-text group-hover:text-cyan-800 dark:group-hover:text-cyan-200">Services</span>
        </div>
        <i class="fas fa-chevron-down transition-transform duration-200 text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 text-sm" id="services-icon"></i>
      </div>
      
      <div id="services-dropdown" class="space-y-2 overflow-hidden transition-all duration-300 max-h-0 ml-4 border-l-2 border-cyan-200 dark:border-cyan-700 pl-3 mt-1">
        <a href="{{ route('admin.ward-bed') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.ward-bed') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-bed text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Wards & Beds</span>
        </a>
        <a href="{{ route('admin.stock') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.stock') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-boxes text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Stock</span>
        </a>
        <a href="{{ route('admin.rooms') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.rooms') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-door-open text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Rooms</span>
        </a>
        <a href="{{ route('admin.faq') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.faq') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-question-circle text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">FAQ</span>
        </a>
        <a href="{{ route('admin.banner') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group {{ request()->routeIs('admin.banner') ? 'bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-300 dark:border-cyan-700 shadow-sm' : 'text-gray-700 dark:text-gray-300' }}">
          <i class="fas fa-image text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Banners</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-headset text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Support & Help Desk</span>
        </a>
      </div>
      
      <div id="pharmacy-toggle" class="flex items-center justify-between mt-3 mb-1 cursor-pointer px-3 py-3 rounded-lg transition-all duration-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 border border-transparent hover:border-cyan-200 group">
        <div class="flex items-center space-x-3">
          <i class="fas fa-pills text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-5 text-center"></i>
          <span class="text-sm text-cyan-700 dark:text-cyan-300 font-semibold sidebar-text group-hover:text-cyan-800 dark:group-hover:text-cyan-200">Pharmacy</span>
        </div>
        <i class="fas fa-chevron-down transition-transform duration-200 text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 text-sm" id="pharmacy-icon"></i>
      </div>
      
      <div id="pharmacy-dropdown" class="space-y-2 overflow-hidden transition-all duration-300 max-h-0 ml-4 border-l-2 border-cyan-200 dark:border-cyan-700 pl-3 mt-1">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-shopping-cart text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Sales & Billing</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-cogs text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Inventory</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-pills text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Medicine</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-chart-line text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-store text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Store</span>
        </a>
      </div>
      
      <div id="account-toggle" class="flex items-center justify-between mt-3 mb-1 cursor-pointer px-3 py-3 rounded-lg transition-all duration-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 border border-transparent hover:border-cyan-200 group">
        <div class="flex items-center space-x-3">
          <i class="fas fa-file-invoice-dollar text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-5 text-center"></i>
          <span class="text-sm text-cyan-700 dark:text-cyan-300 font-semibold sidebar-text group-hover:text-cyan-800 dark:group-hover:text-cyan-200">Accounts</span>
        </div>
        <i class="fas fa-chevron-down transition-transform duration-200 text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 text-sm" id="account-icon"></i>
      </div>
      
      <div id="account-dropdown" class="space-y-2 overflow-hidden transition-all duration-300 max-h-0 ml-4 border-l-2 border-cyan-200 dark:border-cyan-700 pl-3 mt-1">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-money-bill-wave text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Transactions</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-file-invoice text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-dollar-sign text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Pricing & Charges</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-book text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Accounts</span>
        </a>
      </div>
      
      <div id="lab-toggle" class="flex items-center justify-between mt-3 mb-1 cursor-pointer px-3 py-3 rounded-lg transition-all duration-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 border border-transparent hover:border-cyan-200 group">
        <div class="flex items-center space-x-3">
          <i class="fas fa-flask text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-5 text-center"></i>
          <span class="text-sm text-cyan-700 dark:text-cyan-300 font-semibold sidebar-text group-hover:text-cyan-800 dark:group-hover:text-cyan-200">Lab</span>
        </div>
        <i class="fas fa-chevron-down transition-transform duration-200 text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 text-sm" id="lab-icon"></i>
      </div>
      
      <div id="lab-dropdown" class="space-y-2 overflow-hidden transition-all duration-300 max-h-0 ml-4 border-l-2 border-cyan-200 dark:border-cyan-700 pl-3 mt-1">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-flask text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
          <span class="sidebar-text text-sm">Tests</span>
        </a>
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-vial text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
      ...
      <div id="reception-toggle" class="flex items-center justify-between mt-3 mb-1 cursor-pointer px-3 py-3 rounded-lg transition-all duration-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 border border-transparent hover:border-cyan-200 group">
        <div class="flex items-center space-x-3">
          <i class="fas fa-concierge-bell text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-5 text-center"></i>
          <span class="text-sm text-cyan-700 dark:text-cyan-300 font-semibold sidebar-text group-hover:text-cyan-800 dark:group-hover:text-cyan-200">Reception</span>
        </div>
        <i class="fas fa-chevron-down transition-transform duration-200 text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 text-sm" id="reception-icon"></i>
      </div>
      
      <div id="reception-dropdown" class="space-y-2 overflow-hidden transition-all duration-300 max-h-0 ml-4 border-l-2 border-cyan-200 dark:border-cyan-700 pl-3 mt-1">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-200 border border-transparent hover:border-cyan-200 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 group text-gray-700 dark:text-gray-300">
          <i class="fas fa-concierge-bell text-cyan-500 dark:text-cyan-400 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 w-4 text-center text-sm"></i>
