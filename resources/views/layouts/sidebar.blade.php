<aside id="sidebar" class="w-64 fixed top-0 left-0 h-screen overflow-y-auto shadow-lg transition-all duration-300 bg-white" style="-ms-overflow-style: none; scrollbar-width: none;">
  <!-- Logo Section -->
