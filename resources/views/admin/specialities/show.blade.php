...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Speciality Details</h1>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $speciality->id }}</p>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Skill Name</label>
                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $speciality->skill }}</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $speciality->created_at->format('d M Y, H:i') }}</p>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Updated At</label>
                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $speciality->updated_at->format('d M Y, H:i') }}</p>
            </div>

            <div class="flex justify-end">
                <a href="{{ route('admin.specialities.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-2">Back to List</a>
            </div>
        </div>
    </div>
</div>
