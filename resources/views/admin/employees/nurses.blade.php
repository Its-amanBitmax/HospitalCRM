...
<div class="min-h-screen">
    ...
    <div class="flex justify-between items-center bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-6">
        <div class="flex items-center gap-3">
            <i class="fas fa-user-nurse text-2xl text-blue-600 dark:text-blue-400"></i>
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Nurses Management</h1>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
            <i class="fas fa-user-nurse text-3xl text-blue-600 dark:text-blue-400"></i>
            <div>
                <div class="text-2xl font-bold text-gray-800 dark:text-white">{{ $employees->total() }}</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Total Nurses</div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
            ...
            <div>
                ...
                <div class="text-sm text-gray-600 dark:text-gray-400">Specialized Nurses</div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
            ...
            <div>
                ...
                <div class="text-sm text-gray-600 dark:text-gray-400">Qualified Nurses</div>
            </div>
        </div>
    </div>
   ...
   <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    @forelse($employees as $employee)
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 flex flex-col h-full">
            ...
            <!-- Card Footer (Actions) -->
            <div class="p-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 mt-auto">
    ...
    @empty
        <div class="col-span-full text-center py-10">
            <p class="text-gray-500 dark:text-gray-400 text-lg">No nurses found.</p>
        </div>
    @endforelse
</div>
