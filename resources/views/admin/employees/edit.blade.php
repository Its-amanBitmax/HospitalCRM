...
<div class="min-h-screen">
    ...
    <div id="errorToast" class="fixed top-4 right-4 z-50 hidden">
        <div class="bg-red-500 text-black px-6 py-3 rounded-lg shadow-lg flex items-center gap-3 animate-fade-in">
    ...
    <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-semibold text-gray-800 text-black">Edit Employee</h1>
        </div>
        <a href="{{ route('admin.employees.index') }}" class="bg-gray-600 hover:bg-gray-700 text-black px-4 py-2 rounded-lg transition">
    ...
    <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200">
        <form action="{{ route('admin.employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- Basic Information -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Basic Information</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Name *</label>
                        <input type="text" name="name" value="{{ old('name', $employee->name) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black" required>
                        @error('name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Email *</label>
                        <input type="email" name="email" value="{{ old('email', $employee->email) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black" required>
                        @error('email') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Phone</label>
                        <input type="text" name="phone" value="{{ old('phone', $employee->phone) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        @error('phone') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Employee Code *</label>
                        <input type="text" name="employee_code" value="{{ old('employee_code', $employee->employee_code) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black" required>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black" placeholder="Leave blank to keep current password">
                        @error('password') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Confirm Password</label>
                        <input type="password" name="password_confirmation" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black" placeholder="Confirm new password">
                        @error('password_confirmation') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Date of Birth</label>
                        <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $employee->date_of_birth ? $employee->date_of_birth->format('Y-m-d') : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    ...
                    <div>
                        ...
                        <input type="date" name="hire_date" value="{{ old('hire_date', $employee->hire_date ? $employee->hire_date->format('Y-m-d') : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
            ...
            <!-- Specialities -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Specialities</h3>
                <div id="specialities-container">
                    ...
                    <div class="speciality-item grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <select name="specialities[{{ $index }}][speciality_id]" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        ...
                        <div>
                            ...
                            <select name="specialities[{{ $index }}][proficiency_level]" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        ...
                        <div>
                            ...
                            <input type="number" name="specialities[{{ $index }}][years_of_experience]" value="{{ $speciality->pivot->years_of_experience }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <!-- Qualifications -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Qualifications</h3>
                <div id="qualifications-container">
                    ...
                    <div class="qualification-item grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="qualifications[{{ $index }}][degree]" value="{{ old('qualifications.' . $index . '.degree', $qualification->degree) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Institution</label>
                            <input type="text" name="qualifications[{{ $index }}][institution]" value="{{ old('qualifications.' . $index . '.institution', $qualification->institution) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Year Completed</label>
                            <input type="number" name="qualifications[{{ $index }}][year_completed]" value="{{ old('qualifications.' . $index . '.year_completed', $qualification->year_completed) }}" min="1900" max="{{ date('Y') + 10 }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            @if($employee->payroll)
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Payroll Information</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Salary</label>
                        <input type="number" name="payroll[salary]" value="{{ old('payroll.salary', $employee->payroll->salary) }}" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="payroll[bank_account]" value="{{ old('payroll.bank_account', $employee->payroll->bank_account) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Bank Name</label>
                        <input type="text" name="payroll[bank_name]" value="{{ old('payroll.bank_name', $employee->payroll->bank_name) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">IFSC Code</label>
                        <input type="text" name="payroll[ifsc_code]" value="{{ old('payroll.ifsc_code', $employee->payroll->ifsc_code) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">UPI Number</label>
                        <input type="text" name="payroll[upi_number]" value="{{ old('payroll.upi_number', $employee->payroll->upi_number) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">PF Number</label>
                        <input type="text" name="payroll[pf_number]" value="{{ old('payroll.pf_number', $employee->payroll->pf_number) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                    </div>
                </div>
            </div>
            @endif
            ...
            <!-- Addresses -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Addresses</h3>
                <div id="addresses-container">
                    ...
                    <div class="address-item grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="addresses[{{ $index }}][address_type]" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        ...
                        <div>
                            ...
                            <input type="text" name="addresses[{{ $index }}][street]" value="{{ old('addresses.' . $index . '.street', $address->street) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">City</label>
                            <input type="text" name="addresses[{{ $index }}][city]" value="{{ old('addresses.' . $index . '.city', $address->city) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">State</label>
                            <input type="text" name="addresses[{{ $index }}][state]" value="{{ old('addresses.' . $index . '.state', $address->state) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Country</label>
                            <input type="text" name="addresses[{{ $index }}][country]" value="{{ old('addresses.' . $index . '.country', $address->country) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Postal Code</label>
                            <input type="text" name="addresses[{{ $index }}][postal_code]" value="{{ old('addresses.' . $index . '.postal_code', $address->postal_code) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <!-- Family Details -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Family Details</h3>
                <div id="family-container">
                    ...
                    <div class="family-item grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Name</label>
                            <input type="text" name="family_details[{{ $index }}][name]" value="{{ old('family_details.' . $index . '.name', $family->name) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Relationship</label>
                            <input type="text" name="family_details[{{ $index }}][relationship]" value="{{ old('family_details.' . $index . '.relationship', $family->relationship) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Date of Birth</label>
                            <input type="date" name="family_details[{{ $index }}][date_of_birth]" value="{{ old('family_details.' . $index . '.date_of_birth', $family->date_of_birth ? $family->date_of_birth->format('Y-m-d') : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Contact Number</label>
                            <input type="text" name="family_details[{{ $index }}][contact_number]" value="{{ old('family_details.' . $index . '.contact_number', $family->contact_number) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <!-- Shifts -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Shifts</h3>
                <div id="shifts-container">
                    ...
                    <div class="shift-item grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="shifts[{{ $index }}][shift_name]" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        ...
                        // Generate all 30-minute interval slots
                        $timeSlots = [];
                        for ($hour = 0; $hour < 24; $hour++) {
                            ...
                            <div>
                                ...
                                <select name="shifts[{{ $index }}][start_time]"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">

                                    <option value="">Select Start Time</option>

                                    @foreach ($timeSlots as $time)
                                    <option value="{{ $time }}"
                                        {{ old('shifts.' . $index . '.start_time', $savedStart) == $time ? 'selected' : '' }}>
                                        {{ formatAmPm($time) }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="shifts[{{ $index }}][end_time]"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    ...
                                    @foreach ($timeSlots as $time)
                                    <option value="{{ $time }}"
                                        {{ old('shifts.' . $index . '.end_time', $savedEnd) == $time ? 'selected' : '' }}>
                                        {{ formatAmPm($time) }}
                                    </option>
                                    @endforeach
                                </select>
            ...
            <!-- Professions -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Professions</h3>
            ...
            <!-- Documents -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 text-black mb-4">Documents</h3>
                <div id="documents-container">
                    ...
                    <div class="document-item grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="documents[{{ $index }}][document_type]" value="{{ $document->document_type }}" placeholder="e.g., ID Card, Certificate" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black">
                        </div>
                        <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        let specialityIndex = {
            {
                count($employee - > specialities)
            }
        };
        let qualificationIndex = {
            {
                count($employee - > qualifications)
            }
        };
        let addressIndex = {
            {
                count($employee - > addresses)
            }
        };
        let familyIndex = {
            {
                count($employee - > familyDetails)
            }
        };
        let shiftIndex = {
            {
        ...
        let professionIndex = {
            {
                count($employee - > professions)
            }
        };
        let documentIndex = {
            {
                count($employee - > documents)
            }
        };
