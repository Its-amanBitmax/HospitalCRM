...
<div class="min-h-screen">
    ...
    <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-semibold text-gray-800 ">Employee Details</h1>
        </div>
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.employees.index') }}"
                class="bg-gray-600 hover:bg-gray-700 text-black dark:text-black px-4 py-2 rounded-lg transition flex items-center gap-2">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-900 ">{{ $employee->date_of_birth ? \Carbon\Carbon::parse($employee->date_of_birth)->format('d M Y') : 'N/A' }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Gender</label>
                    <p class="text-gray-900 ">{{ $employee->gender ?? 'N/A' }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Hire Date</label>
                    <p class="text-gray-900 ">{{ $employee->hire_date ? \Carbon\Carbon::parse($employee->hire_date)->format('d M Y') : 'N/A' }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Department</label>
                    <p class="text-gray-900 ">{{ $employee->professions->first()->department->name ?? $employee->department->name ?? 'N/A' }}</p>
                </div>
                <div>
    ...
    {{ $employee->status == 'Active' 
        ...
        : 'bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-200' 
                ...
                <div class="md:col-span-2">
                    ...
                    @else
                    <p class="text-gray-900 ">No image uploaded</p>
                    @endif
                </div>
            </div>
        </div>
        ...
        <!-- Specialities -->
        <div class="mb-6">
            <h3 class="text-lg font-semibold text-gray-800  mb-4">Specialities</h3>
        ...
        <div class="mb-6">
            ...
            @else
            <p class="text-gray-900 ">No qualifications added</p>
            @endif
        </div>
