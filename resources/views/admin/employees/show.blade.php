...
<div class="min-h-screen">
    ...
    <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-semibold text-gray-800 text-white">Employee Details</h1>
        </div>
    ...
    <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200 border-gray-700">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    @else
                        <p class="text-gray-900 text-white">No image uploaded</p>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            @if($employee->specialities->count() > 0)
                <div class="space-y-2">
                    @foreach($employee->specialities as $speciality)
                        <div class="bg-white-50 bg-white-700 p-3 rounded">
            ...
            @else
                <p class="text-gray-900 text-white">No specialities added</p>
            @endif
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <p class="text-gray-900 text-white">No qualifications added</p>
            @endif
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <p class="text-gray-900 text-white">No addresses added</p>
            @endif
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <p class="text-gray-900 text-white">No family details added</p>
            @endif
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <p class="text-gray-900 text-white">No shifts added</p>
            @endif
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <p class="text-gray-900 text-white">No professions added</p>
            @endif
        </div>
        ...
        <div class="mb-6">
            ...
            @else
                <p class="text-gray-900 text-white">No documents added</p>
            @endif
        </div>
    </div>
</div>
