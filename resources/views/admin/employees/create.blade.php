...
<div class="min-h-screen">
    ...
    <div id="error-toast" class="fixed top-4 right-4 z-50 max-w-md">
        <div class="bg-red-500 text-black px-6 py-3 rounded-lg shadow-lg flex items-start gap-3 animate-fade-in">
            ...
            <button onclick="this.parentElement.parentElement.style.display='none'" class="text-black hover:text-gray-200">
    ...
    <!-- Form -->
    <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6">
...
<div>
    ...
    <select name="shifts[0][start_time]"
            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-black">

        <option value="">Select Start Time</option>

        @foreach ($timeSlots as $time)
            <option value="{{ $time }}" {{ old('shifts.0.start_time') == $time ? 'selected' : '' }}>
                {{ formatAmPm($time) }}
            </option>
        @endforeach
    </select>
...
<div>
    ...
    <select name="shifts[0][end_time]"
            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-black">

        <option value="">Select End Time</option>

        @foreach ($timeSlots as $time)
            <option value="{{ $time }}" {{ old('shifts.0.end_time') == $time ? 'selected' : '' }}>
                {{ formatAmPm($time) }}
            </option>
        @endforeach
    </select>
