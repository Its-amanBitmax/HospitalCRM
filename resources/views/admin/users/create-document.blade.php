...
<div class="min-h-screen">
  ...
  <div class="flex justify-between items-center bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-6">
    <div class="flex items-center gap-3">
      ...
      <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Add New Document - {{ $user->full_name }}</h1>
    </div>
        ...
        <div class="section">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select name="document_type" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition duration-200" required>
            ...
            <div class="md:col-span-2">
              ...
              <input type="file" name="document" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition duration-200" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Accepted formats: PDF, DOC, DOCX, JPG, JPEG, PNG</p>
            </div>
          </div>
        </div>
