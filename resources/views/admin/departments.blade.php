...
<div class="min-h-screen">
  ...
  <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
    <div class="flex items-center gap-3">
      ...
      <h1 class="text-xl font-semibold text-gray-800 text-black">Departments</h1>
    </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-800 text-black" id="totalDepartments">0</div>
    ...
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-800 text-black" id="activeDepartments">0</div>
    ...
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-800 text-black" id="inactiveDepartments">0</div>
    ...
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
      ...
      <div>
        <div class="text-2xl font-bold text-gray-800 text-black" id="recentDepartments">0</div>
  ...
  <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200 ">
    ...
    <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
        ...
        <input type="text" id="departmentNameFilter" class="mt-1 block w-full px-3 py-2 border border-gray-300  rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black transition duration-200" placeholder="Enter department name">
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Filter by Code</label>
        <input type="text" id="departmentCodeFilter" class="mt-1 block w-full px-3 py-2 border border-gray-300  rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black transition duration-200" placeholder="Enter department code">
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Filter by Status</label>
        <select id="departmentStatusFilter" class="mt-1 block w-full px-3 py-2 border border-gray-300  rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white-700 text-black transition duration-200">
    ...
    <div class="overflow-x-auto">
      <table class="w-full table-auto border-collapse">
        ...
        <tbody id="departmentTable" class="text-gray-800 text-gray-200 divide-y divide-gray-200 "></tbody>
      </table>
    </div>
  </div>
