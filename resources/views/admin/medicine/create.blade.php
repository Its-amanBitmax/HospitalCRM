        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Create and register new medicine for the selected store</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-white">Medicine Information</h2>
                </div>
            </div>

            <!-- Form Content -->
            <form method="POST" action="{{ route('admin.medicine.store') }}" enctype="multipart/form-data" class="p-6 sm:p-8">
                @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Set medicine availability</p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <ul class="mt-1 text-sm text-blue-700 space-y-1">
                        <li class="flex items-start">
                            ...
                            Make sure to select the correct store for the medicine
                        </li>
                        <li class="flex items-start">
                            <span class="inline-block w-1 h-1 bg-blue-500 rounded-full mt-1.5 mr-2"></span>
                            Set appropriate expiry dates to manage inventory effectively
                        </li>
                        <li class="flex items-start">
                            <span class="inline-block w-1 h-1 bg-blue-500 rounded-full mt-1.5 mr-2"></span>
                            Sale price must be higher than purchase price for profit margin
                        </li>
                    </ul>
                </div>
            </div>
            ...
            fileInput.addEventListener('change', function(e) {
                ...
                if (fileName) {
                    ...
                    if (svg && text) {
                        ...
                        text.innerHTML = `<p class="font-medium text-green-600">${fileName}</p><p class="text-xs text-gray-500">Click to change</p>`;
                    }
                }
            });
        }
