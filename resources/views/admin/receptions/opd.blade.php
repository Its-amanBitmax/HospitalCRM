    ...
    <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200  overflow-x-auto">
        ...
        <div class="overflow-x-auto">
            <table class="w-full table-auto border-collapse min-w-max">
                ...
                <tbody id="userTable" class="text-gray-800 text-gray-200 divide-y divide-gray-200 divide-gray-600">
                    ...
                    <tr class="bg-white-800">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <a href="{{ url('/admin/users/'.$u->id) }}" class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm inline-block"><i class="fas fa-eye"></i></a>
