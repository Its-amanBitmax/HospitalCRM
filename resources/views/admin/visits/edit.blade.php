...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white bg-white-800 rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 text-white">Edit Hospital Visit</h1>
        ...
        <form action="{{ route('admin.visits.update', $visit) }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white-50 bg-white-700 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" required class="w-full border border-gray-300 border-gray-600 rounded-lg px-3 py-2 bg-white bg-white-800">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Check In</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Check Out</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Invite Status</label>
                        <select name="invite_status" class="w-full border border-gray-300 border-gray-600 rounded-lg px-3 py-2 bg-white bg-white-800">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" rows="3" class="w-full border border-gray-300 border-gray-600 rounded-lg px-3 py-2 bg-white bg-white-800">{{ old('notes', $visit->notes) }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white-50 bg-white-700 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 text-gray-300 mb-1">Badge Number</label>
