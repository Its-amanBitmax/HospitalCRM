...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-200 dark:border-gray-700 hover:scale-105">
            <div class="flex items-center gap-4">
                <div class="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 p-4 rounded-full">
                    <i class="fas fa-users text-blue-600 dark:text-blue-300 text-2xl"></i>
                </div>
                <div>
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Visits</p>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-200 dark:border-gray-700 hover:scale-105">
            <div class="flex items-center gap-4">
                <div class="bg-gradient-to-br from-yellow-100 to-yellow-200 dark:from-yellow-900 dark:to-yellow-800 p-4 rounded-full">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['scheduled'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-200 dark:border-gray-700 hover:scale-105">
            <div class="flex items-center gap-4">
                <div class="bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900 dark:to-green-800 p-4 rounded-full">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-200 dark:border-gray-700 hover:scale-105">
            <div class="flex items-center gap-4">
                <div class="bg-gradient-to-br from-red-100 to-red-200 dark:from-red-900 dark:to-red-800 p-4 rounded-full">
                    <i class="fas fa-exclamation-triangle text-red-600 dark:text-red-300 text-2xl"></i>
                </div>
                <div>
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-medium">Emergency Visits</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['emergency'] }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Hospital Visits</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Manage and track all hospital visits</p>
            </div>
        ...
        <div class="mb-6 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="visit_type" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-800">
                ...
                <div>
                    ...
                    <select name="status" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input type="date" name="start_date" value="{{ request('start_date') }}" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-800">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="end_date" value="{{ request('end_date') }}" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-800">
                </div>
                ...
                <div class="md:col-span-4">
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search visitor or patient" class="flex-1 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-800">
    ...
    @forelse($visits as $visit)
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-200 border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="mb-3">
                ...
                <p class="font-medium text-gray-800 dark:text-gray-200 flex items-center gap-1">
                    @if($visit->patient)
