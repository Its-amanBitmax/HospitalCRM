...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white bg-white-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-200 hover:scale-105">
        ...
        <div class="bg-white bg-white-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-200  hover:scale-105">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 ">{{ $stats['emergency'] }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white bg-white-800 rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 ">Hospital Visits</h1>
        ...
        <div class="mb-6 bg-white-50 bg-white-700 p-4 rounded-lg">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="visit_type" class="w-full border border-gray-300  rounded-lg px-3 py-2 bg-white bg-white-800">
                ...
                <div>
                    ...
                    <select name="status" class="w-full border border-gray-300  rounded-lg px-3 py-2 bg-white bg-white-800">
                ...
                <div>
                    ...
                    <input type="date" name="start_date" value="{{ request('start_date') }}" class="w-full border border-gray-300  rounded-lg px-3 py-2 bg-white bg-white-800">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="end_date" value="{{ request('end_date') }}" class="w-full border border-gray-300  rounded-lg px-3 py-2 bg-white bg-white-800">
                </div>
                ...
                <div class="md:col-span-4">
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search visitor or patient" class="flex-1 border border-gray-300  rounded-lg px-3 py-2 bg-white bg-white-800">
    ...
    @forelse($visits as $visit)
        ...
        <div class="bg-white bg-white-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-200 border border-gray-200  p-6">
