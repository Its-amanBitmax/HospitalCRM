  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
      ...
      <div>
        ...
        <div class="text-sm text-gray-600 dark:text-gray-400">Total OPD Patients</div>
      </div>
    </div>
    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex items-center gap-3">
      <i class="fas fa-stethoscope text-3xl text-purple-600 dark:text-purple-400"></i>
      <div>
        <div class="text-2xl font-bold text-gray-800 dark:text-white" id="opdPatients">0</div>
        <div class="text-sm text-gray-600 dark:text-gray-400">OPD</div>
      </div>
    </div>
  </div>
