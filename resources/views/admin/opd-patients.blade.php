...
<div class="min-h-screen">
  ...
  <div class="flex justify-between items-center bg-white bg-white-800 p-4 rounded-lg shadow mb-6">
    <div class="flex items-center gap-3">
      <i class="fas fa-stethoscope text-2xl text-green-600 text-green-400"></i>
      <h1 class="text-xl font-semibold text-gray-800 text-black">OPD Patients</h1>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
      ...
      <div>
        ...
        <div class="text-sm text-gray-600 text-gray-400">Total OPD Patients</div>
      </div>
    </div>
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
    ...
    <div class="bg-white bg-white-800 p-4 rounded-lg shadow flex items-center gap-3">
      <i class="fas fa-stethoscope text-3xl text-purple-600 text-purple-400"></i>
      <div>
        <div class="text-2xl font-bold text-gray-800 text-black" id="opdPatients">0</div>
        <div class="text-sm text-gray-600 text-gray-400">OPD</div>
      </div>
    </div>
  </div>
  ...
  <div class="bg-white bg-white-800 rounded-lg shadow-lg p-6 border border-gray-200">
    ...
    <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div class="flex items-end">
        <button class="bg-gray-500 hover:bg-white-600 text-black px-4 py-2 rounded-lg transition" id="clearPatientFilters">Clear Filters</button>
      </div>
    </div>
...
window.opdPatientsScriptLoaded = true;
...
function updateDashboard() {
  ...
  document.getElementById("opdPatients").textContent = patients.filter(p => p.type === "opd").length;
}
...
document.getElementById("editPatientForm").addEventListener("submit", (e) => {
  ...
  fetch(`/admin/update-opd-patient/${id}`, {
    method: 'PUT',
    headers: {
